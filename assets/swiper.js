  ...
  (i.r = (e) => {
    ...
    (() => {
        ...
        if ("string" == typeof e) {
          ...
          if (o.indexOf("<") >= 0 && o.indexOf(">") >= 0) {
            ...
            r = (function (e, t) {
              ...
              for (
                var i = [], a = t.querySelectorAll(e), s = 0;
                s < a.length;
                s += 1
              )
                i.push(a[s]);
        ...
        return function () {
          ...
          if (void 0 === i[0]) {
            for (var s = 0; s < this.length; s += 1)
              h.indexOf(e) < 0 &&
                (e in this[s] ? this[s][e]() : f(this[s]).trigger(e));
            return this;
          }
      ...
      var g = {
        ...
        on: function () {
          ...
          function o(e) {
            ...
            if (t) {
              ...
              if ((i.indexOf(e) < 0 && i.unshift(e), f(t).is(s))) r.apply(t, i);
              else
                for (var a = f(t).parents(), n = 0; n < a.length; n += 1)
                  f(a[n]).is(s) && r.apply(a[n], i);
            }
          }
          function l(e) {
            ...
            if (s)
              ...
              for (d = 0; d < u.length; d += 1) {
                ...
                c.dom7Listeners || (c.dom7Listeners = {}),
                  ...
                  c.dom7Listeners[h].push({ listener: r, proxyListener: l }),
          ...
          for (var o = a.split(" "), l = 0; l < o.length; l += 1)
            for (var d = o[l], u = 0; u < this.length; u += 1) {
              ...
              if (
                (!s && p.dom7Listeners
                  ? (c = p.dom7Listeners[d])
                  : s && p.dom7LiveListeners && (c = p.dom7LiveListeners[d]),
                c && c.length)
              )
        ...
        trigger: function () {
          for (
            var e = n(), t = arguments.length, i = new Array(t), a = 0;
            a < t;
            a++
          )
            i[a] = arguments[a];
        ...
        offset: function () {
          if (this.length > 0) {
            ...
            return { top: a.top + d - o, left: a.left + u - l };
          }
          return null;
        },
        css: function (e, t) {
        ...
        nextAll: function (e) {
          ...
          for (; i.nextElementSibling; ) {
            ...
            e ? f(a).is(e) && t.push(a) : t.push(a), (i = a);
          }
          return f(t);
        },
        prev: function (e) {
        ...
        parents: function (e) {
          for (var t = [], i = 0; i < this.length; i += 1)
            for (var a = this[i].parentNode; a; )
              e ? f(a).is(e) && t.push(a) : t.push(a), (a = a.parentNode);
          return f(t);
        },
        closest: function (e) {
          var t = this;
        ...
        find: function (e) {
          for (var t = [], i = 0; i < this.length; i += 1)
            for (
              var a = this[i].querySelectorAll(e), s = 0;
              s < a.length;
              s += 1
            )
              t.push(a[s]);
        ...
        children: function (e) {
          for (var t = [], i = 0; i < this.length; i += 1)
            for (var a = this[i].children, s = 0; s < a.length; s += 1)
              (e && !f(a[s]).is(e)) || t.push(a[s]);
          return f(t);
        },
        filter: function (e) {
          return f(v(this, e));
            ...
            for (
              ...
              void 0 !== d &&
                ...
                (T(t[l]) && T(s[l])
                  ...
                  : !T(t[l]) && T(s[l])
                    ? ((t[l] = {}),
                      s[l].__swiper__ ? (t[l] = s[l]) : S(t[l], s[l]))
                    : (t[l] = s[l]));
            }
        }
        return t;
          ...
          i &&
            Object.keys(a).forEach(function (i) {
              if (!t[i] && !0 === t.auto) {
                ...
                (s.className = a[i]), e.append(s), (t[i] = s);
              }
            }),
          t
        );
      ...
      const G = {
        ...
        $ = {
          ...
          onAny: function (e, t) {
            ...
            return (
              i.eventsAnyListeners.indexOf(e) < 0 && i.eventsAnyListeners[a](e),
              i
            );
          },
          offAny: function (e) {
          ...
          emit: function () {
            ...
            return (
              "string" == typeof r[0] || Array.isArray(r[0])
                ...
                : ((e = r[0].events), (t = r[0].data), (i = r[0].context || a)),
              t.unshift(i),
      ...
      const N = {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== r) {
            ...
            "string" == typeof y &&
              ...
              a.slidesPerColumn > 1 &&
                ((x =
                  Math.floor(p / a.slidesPerColumn) ===
            ...
            for (
              var M,
                ...
                L = a.slidesPerColumn,
                O = x / L,
                I = Math.floor(p / a.slidesPerColumn),
                z = 0;
              z < p;
              z += 1
            ) {
              ...
              if (a.slidesPerColumn > 1) {
                ...
                if ("row" === a.slidesPerColumnFill && a.slidesPerGroup > 1) {
                  var $ = Math.floor(
                      z / (a.slidesPerGroup * a.slidesPerColumn),
                    ),
                    N = z - a.slidesPerColumn * a.slidesPerGroup * $,
                    _ =
                      0 === $
                        ? a.slidesPerGroup
                        : Math.min(
                            Math.ceil((p - $ * L * a.slidesPerGroup) / L),
                            a.slidesPerGroup,
                          );
                  (B =
                    (D =
                      N - (G = Math.floor(N / _)) * _ + $ * a.slidesPerGroup) +
                    (G * x) / L),
                    A.css({
                  ...
                  "column" === a.slidesPerColumnFill
                    ? ((G = z - (D = Math.floor(z / L)) * L),
                      (D > I || (D === I && G === L - 1)) &&
                        (G += 1) >= L &&
                        ((G = 0), (D += 1)))
                    : (D = z - (G = Math.floor(z / O)) * O);
                A.css(
                  t("margin-top"),
                ...
                if ("auto" === a.slidesPerView) {
                  ...
                  if (
                    ...
                    if (Y && "border-box" === Y) E = V + W + X;
                      ...
                      var U = A[0],
                        K = U.clientWidth;
                      E = V + q + R + W + X + (U.offsetWidth - K);
                    }
                  }
                  F && (A[0].style.transform = F),
                    H && (A[0].style.webkitTransform = H),
                    a.roundLengths && (E = Math.floor(E));
                } else
                  (E = (r - (a.slidesPerView - 1) * y) / a.slidesPerView),
                    a.roundLengths && (E = Math.floor(E)),
            ...
            if (a.slidesPerColumn > 1)
              if (
                ((e.virtualSize = (E + a.spaceBetween) * x),
                (e.virtualSize =
            ...
            S(e, { slides: u, snapGrid: c, slidesGrid: v, slidesSizesGrid: f }),
        ...
        updateActiveIndex: function (e) {
          ...
          if (r.indexOf(a) >= 0) t = r.indexOf(a);
            ...
            var c = Math.min(n.slidesPerGroupSkip, u);
            t = c + Math.floor((u - c) / n.slidesPerGroup);
          }
        ...
        updateClickedSlide: function (e) {
          var t,
            i = this,
            a = i.params,
            s = b(e.target).closest("." + a.slideClass)[0],
            r = !1;
          if (s)
      ...
      const F = {
        ...
        slideToLoop: function (e, t, i, a) {
          ...
          var s = this,
            r = e;
          return s.params.loop && (r += s.loopedSlides), s.slideTo(r, t, i, a);
        },
        slideNext: function (e, t, i) {
          ...
          var n = a.activeIndex < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup;
          if (s.loop) {
        ...
        slideToClosest: function (e, t, i, a) {
          ...
          if (l >= s.snapGrid[o]) {
            var d = s.snapGrid[o];
            l - d > (s.snapGrid[o + 1] - d) * a &&
              (r += s.params.slidesPerGroup);
          } else {
            var u = s.snapGrid[o - 1];
            l - u <= (s.snapGrid[o] - u) * a && (r -= s.params.slidesPerGroup);
          }
          return (
            (r = Math.max(r, 0)),
      ...
      const H = {
        loopCreate: function () {
          ...
          for (var p = 0; p < u.length; p += 1)
            a.append(b(u[p].cloneNode(!0)).addClass(i.slideDuplicateClass));
          for (var c = d.length - 1; c >= 0; c -= 1)
            a.prepend(b(d[c].cloneNode(!0)).addClass(i.slideDuplicateClass));
        },
        loopFix: function () {
          var e = this;
            ...
            if (
              ...
              if (
                ...
                u.is(r.focusableElements) && (g = !1),
                  i.activeElement &&
                    b(i.activeElement).is(r.focusableElements) &&
                    i.activeElement !== u[0] &&
            ...
            if (!a.isTouchEvent || "touchmove" === l.type) {
              ...
              if (!i.allowTouchMove)
                return (
                  ...
                  void (
                    a.isTouched &&
                    (S(n, { startX: u, startY: p, currentX: u, currentY: p }),
                    (a.touchStartTime = w()))
                  )
                );
              ...
              if (
                ...
                b(l.target).is(a.focusableElements)
              )
                  ...
                  if (
                    ...
                    r.followFinger &&
                      ...
                      r.freeMode &&
                        ...
                        a.velocities.push({
                          position:
                            n[i.isHorizontal() ? "currentX" : "currentY"],
                          time: w(),
                        })),
        ...
        if (t.enabled) {
          ...
          if (
            ...
            if (a.freeMode) {
              ...
              if (a.freeModeMomentum) {
                if (i.velocities.length > 1) {
                  ...
                  (t.velocity = h / m),
                    ...
                    Math.abs(t.velocity) < a.freeModeMinimumVelocity &&
                      (t.velocity = 0),
                    (m > 150 || w() - v.time > 300) && (t.velocity = 0);
                } else t.velocity = 0;
                ...
                if (C < t.maxTranslate())
                  a.freeModeMomentumBounce
                    ? (C + t.maxTranslate() < -E && (C = t.maxTranslate() - E),
                      (T = t.maxTranslate()),
                      (x = !0),
                  ...
                  a.freeModeMomentumBounce
                    ? (C - t.minTranslate() > E && (C = t.minTranslate() + E),
                      (T = t.minTranslate()),
                      (x = !0),
                      (i.allowMomentumBounce = !0))
                    : (C = t.minTranslate()),
              ...
              for (
                var O = 0, I = t.slidesSizesGrid[0], z = 0;
                z < o.length;
                z += z < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup
              ) {
                var A = z < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
                void 0 !== o[z + A]
                  ? u >= o[z] &&
                    u < o[z + A] &&
                    ((O = z), (I = o[z + A] - o[z]))
                  : u >= o[z] &&
                    ((O = z), (I = o[o.length - 1] - o[o.length - 2]));
              }
              var B = (u - o[O]) / I,
                D = O < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
              if (c > a.longSwipesMs) {
                if (!a.longSwipes) return void t.slideTo(t.activeIndex);
                "next" === t.swipeDirection &&
                  (B >= a.longSwipesRatio ? t.slideTo(O + D) : t.slideTo(O)),
          ...
          if ((void 0 === t && (t = "window"), e && ("container" !== t || i))) {
            ...
            for (var l = 0; l < o.length; l += 1) {
              var d = o[l],
                ...
                p = d.value;
              "window" === t
                ? s.matchMedia("(min-width: " + p + "px)").matches && (a = u)
                : p <= i.clientWidth && (a = u);
            }
            return a || "max";
          }
      ...
      var ne = {
        ...
        le = (function () {
          function e() {
            for (
              var t, i, a = arguments.length, s = new Array(a), r = 0;
              r < a;
              r++
            )
              s[r] = arguments[r];
            ...
            (r.slidesPerViewDynamic = function () {
              ...
              if (t.centeredSlides) {
                for (
                  ...
                  i[d] &&
                    !o &&
                    ((n += 1), (l += i[d].swiperSlideSize) > s && (o = !0));
                for (var u = r - 1; u >= 0; u -= 1)
                  i[u] &&
                    !o &&
                    ((n += 1), (l += i[u].swiperSlideSize) > s && (o = !0));
              } else
              ...
              var a = function () {
                ...
                r = (function () {
                  if (e && e.shadowRoot && e.shadowRoot.querySelector) {
                    var t = b(e.shadowRoot.querySelector(a()));
                    return (
        ...
        on: {
          ...
          click: function (e, t) {
            var i = e.navigation,
              ...
              s = i.$prevEl,
              r = t.target;
            if (e.params.navigation.hideOnClick && !b(r).is(s) && !b(r).is(a)) {
              if (
                e.pagination &&
                e.params.pagination &&
      ...
      var fe = {
        update: function () {
          ...
          if (
            ...
            if (
              ("fraction" === i.type &&
                (r.find(E(i.currentClass)).text(i.formatFractionCurrent(a + 1)),
                r.find(E(i.totalClass)).text(i.formatFractionTotal(n))),
              "progressbar" === i.type)
            ) {
              var C;
              ...
              for (var n = 0; n < r; n += 1)
                t.renderBullet
                  ...
                  : (s +=
                      ...
                      t.bulletElement +
                      ">");
              a.html(s), (e.pagination.bullets = a.find(E(t.bulletClass)));
            }
            "fraction" === t.type &&
              ((s = t.renderFraction
      ...
      const he = {
        ...
        create: function () {
          x(this, { pagination: ve({ dynamicBulletIndex: 0 }, fe) });
        },
        on: {
          init: function (e) {
      ...
      var ge = {
        ...
        onThumbClick: function () {
          ...
          if (t) {
            ...
            if (
              !(
                (a && b(a).hasClass(e.params.thumbs.slideThumbActiveClass)) ||
                null == i
              )
            ) {
              var s;
      ...
      const be = {
        ...
        create: function () {
          x(this, { thumbs: me({ swiper: null, initialized: !1 }, ge) });
        },
        on: {
      ...
      const Ce = {
        ...
        create: function () {
          x(this, { autoplay: ye({}, we, { running: !1, paused: !1 }) });
        },
        on: {
          init: function (e) {
